...
public class UserServlet extends HttpServlet {
	...
	public void doAdd(HttpServletRequest request, HttpServletResponse response)
		...
		if (stop != null) {
			...
			int num = ud.add(u);
			if (num != 0) {
				out.print("<script type='text/javascript'>alert('保存成功!');location.href='loading.jsp';</script>");
			} else {
				out.print("<script type='text/javascript'>alert('保存失败!');location.href='loading.jsp';</script>");
			}
		}
	}
	...
	public void doUpd(HttpServletRequest request, HttpServletResponse response)
		...
		if (stop != null) {
			...
			int num = ud.upd(u);
			if (num != 0) {
				out.print("<script type='text/javascript'>alert('修改成功!');location.href='loading.jsp';</script>");
			} else {
				out.print("<script type='text/javascript'>alert('修改失败!');location.href='loading.jsp';</script>");
			}
		}
	}
	...
	public void doDel(HttpServletRequest request, HttpServletResponse response)
		...
		int num = ud.del(id);
		if (num != 0) {
			out.print("<script type='text/javascript'>alert('删除成功!');location.href='loading.jsp';</script>");
		} else {
			out.print("<script type='text/javascript'>alert('删除失败!');location.href='loading.jsp';</script>");
		}
	}
